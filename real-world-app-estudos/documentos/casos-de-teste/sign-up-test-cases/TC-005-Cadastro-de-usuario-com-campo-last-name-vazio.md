<table>
  ...
  <tr>
    ...
    <td colspan = 5>
      Cadastro de usuário com campo "Last Name" vazio.
    </td>
  </tr>
  <tr>
    <th>
  ...
  <tr>
    ...
    <td colspan = 5>
      - O sistema deve exibir uma mensagem de erro informando que o campo "Last Name" é obrigatório. <br/>
  ...
  <tr>
    ...
    <td colspan = 5>
      - A mensagem de erro apareceu corretamente para o campo "Last Name". <br/>
