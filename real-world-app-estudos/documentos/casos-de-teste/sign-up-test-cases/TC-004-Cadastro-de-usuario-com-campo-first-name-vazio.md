<table>
  ...
  <tr>
    ...
    <td colspan = 5>
      Cadastro de usuário com campo "First Name" vazio.
    </td>
  </tr>
  <tr>
    <th>
  ...
  <tr>
    ...
    <td colspan = 5>
      First Name: (vazio) <br/>			
      Last Name: válido <br/>
      Username: válido e não cadastrado <br/>
      Password: válido <br/>
  ...
  <tr>
    ...
    <td colspan = 5>
      1 - Clicar no campo "First Name" e sair do campo sem preenchê-lo. <br/>
      2 - Preencher os campos "Last Name", "Username", "Password" e "Confirm Password" conforme os dados informados. 
    </td>
  </tr>
  <tr>
    <th>
    ...
    <td colspan = 5>
      - O sistema deve exibir uma mensagem de erro informando que o campo "First Name" é obrigatório. <br/>
  ...
  <tr>
    ...
    <td colspan = 5>
      - A mensagem de erro apareceu corretamente para o campo "First Name". <br/>
