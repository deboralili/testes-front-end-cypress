<table>
  ...
  <tr>
    ...
    <td colspan = 5>
      Cadastro de usuário com campo "Username" vazio.
    </td>
  </tr>
  <tr>
    <th>
  ...
  <tr>
    ...
    <td colspan = 5>
      ...
      2 - Clicar no campo "Username" e sair do campo sem preenchê-lo. <br/>
      3 - Preencher os campos "First Name", "Last Name", "Password" e "Confirm Password" conforme os dados informados.
    </td>
  </tr>
  <tr>
    <th>
    ...
    <td colspan = 5>
      - O sistema deve exibir uma mensagem de erro informando que o campo "Username" é obrigatório. <br/>
  ...
  <tr>
    ...
    <td colspan = 5>
      - A mensagem de erro apareceu corretamente para o campo "Username". <br/>
